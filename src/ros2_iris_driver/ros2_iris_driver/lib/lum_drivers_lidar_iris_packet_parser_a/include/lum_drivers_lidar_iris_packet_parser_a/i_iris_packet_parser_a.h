...
#ifndef LUM_DRIVERS_LIDAR_IRIS_PACKET_PARSER_A_I_IRIS_PACKET_PARSER_A_H
#define LUM_DRIVERS_LIDAR_IRIS_PACKET_PARSER_A_I_IRIS_PACKET_PARSER_A_H
...
public:
  ...
  IIrisPacketParserA() = default;
  virtual ~IIrisPacketParserA() = default;
  IIrisPacketParserA(const IIrisPacketParserA&) = delete;
  IIrisPacketParserA(IIrisPacketParserA&&) = delete;
  void operator=(const IIrisPacketParserA&) & = delete;
  void operator=(IIrisPacketParserA&&) & = delete;
};

/// Gets a string corresponding to the enum values of IIrisPacketParserA::ParsingStatus
constexpr const char* getParsingStatusMessage(const IIrisPacketParserA::ParsingStatus status)
{
  ...
  const auto index = common::types::utils::toUnderlyingValue(status);
...
#endif // LUM_DRIVERS_LIDAR_IRIS_PACKET_PARSER_A_I_IRIS_PACKET_PARSER_A_H
