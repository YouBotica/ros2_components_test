...
: ${AMENT_CURRENT_PREFIX:="/home/artificial/bags_ws/install/my_cpp_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_cpp_package/environment/library_path.sh"
