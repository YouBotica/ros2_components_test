...
static const _SensorHealth_type_support_symbol_names_t _SensorHealth_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, luminar_iris_msgs, msg, SensorHealth)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, luminar_iris_msgs, msg, SensorHealth)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, luminar_iris_msgs, msg, SensorHealth)() {
  return &::luminar_iris_msgs::msg::rosidl_typesupport_c::SensorHealth_message_type_support_handle;
}
